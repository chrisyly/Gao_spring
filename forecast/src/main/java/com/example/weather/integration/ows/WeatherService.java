...
public class WeatherService {
	...
	@Cacheable("forecast")
	public WeatherForecast getWeatherForecast(String countryCode, String city, String cnt) {
		logger.info("Requesting weather forecast for {}/{}/{}", countryCode, city, cnt);
		URI url = new UriTemplate(FORECAST_URL).expand(city, countryCode,cnt, this.apiKey);
